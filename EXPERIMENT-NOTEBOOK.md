...
| E03 | Chance, no-communication, and random-message controls | E01, E02 | Not started | Not tested | Qualification ready | E02 qualified; v1/v2 pilot packets remain unused; v3 original 120-run Prototype-Mode pilot and separate audits passed; the 25-pair full packet and its simulated commitment are frozen, with 150 primary and at most 18 paired-reserve runs; no full seed has executed |
...
- [ ] Require a matching live controller for any pre-terminal running claim;
      a stale start record alone does not establish execution progress.
