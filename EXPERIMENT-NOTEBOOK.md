...
| E03 | Chance, no-communication, and random-message controls | E01, E02 | Completed | Not tested | Qualification complete | Registered Prototype-Mode v1 completed 150/150 required primary runs with verified bundles, 0 invalid and 0 reserve attempts; all fixed thresholds and the separate 150-bundle audit passed; 18 reserves correctly remained unattempted; this is control software qualification, not a behavioral finding |
