...
| Experiments have ordered prerequisites and explicit status | Experiment notebook, `490ef05` | Backlog gates and registration compiler | E00 and E01 are software-qualified; E02 has two retained failed qualification attempts; 16 experiments remain `Not started` |
