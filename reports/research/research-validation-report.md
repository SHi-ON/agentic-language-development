...
Latest tracked research-design candidate: v0.1.117 (D08 and A03 in progress; A01 snapshot complete)
...
- The prospective E02 controller now fixes 2,016 rows per role/stage and at least
  ...
  slot stopped at the registered safety pause after 465 turns. The prospectively
...
- The complete local data/claim snapshot resolves and hash-binds 140 exported bundles
  in 22 collections. All are excluded from empirical estimates; 92 local fake-chain
...
- E00 v5 is a successful prospectively registered software qualification: both
  ...
  five registered slots and dual-verifier acceptance. E02 v1 and v2 have unsuccessful
  retained attempts;
...
exported bundle present in ignored local evidence storage at the cutoff: 140 bundles,
22 collections, and 259,037,705 bundle bytes. It records content-tree, manifest, and
...
33 are historical qualification exports, and 61 are development, failed, or superseded diagnostic
artifacts. Every one is excluded from pilot, confirmatory, replication, and empirical
hypothesis estimates.

Of 140 exports, 139 have a recorded verifier exit code of zero; one partial
...
verifier status. Ninety-two bundle records show anchor confirmation, but those
