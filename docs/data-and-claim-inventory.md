...
The snapshot contains 140 bundles in 22 collections and 259,037,705 bundle bytes.
...
61 belong to development, failed, or superseded diagnostics, and 46 have tracked bounded software
qualification support. All 140 are excluded from empirical estimates.

Ninety-two bundle records show anchor confirmation, but every such confirmation
...
| Development, failed, or superseded diagnostic | 61 | Development behavior, failure history, and debugging provenance only |
| Pilot | 0 | None |
| Confirmatory | 0 | None |
| Replication | 0 | None |
