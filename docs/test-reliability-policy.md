...
The first job runs all lints, readiness and acceptance-coverage checks, the
TypeScript build, all Vitest tests, and the secret scanner. The Mode R job runs
the separate-container isolation and training suite. The 20 randomized
