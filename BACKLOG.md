...
- **Acceptance criteria:**
  ...
  - [x] The pilot reducer requires all five non-oracle conditions and exactly twenty
  200-episode slots, emits only dispersion/design inputs, and blocks the frozen table
  when estimated latent seed-rate dispersion exceeds 0.20.
